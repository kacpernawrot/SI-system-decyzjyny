...
class ShouldBuy implements ActionListener
  {  
   JLabel displayLabel;
   JButton nextButton;
   JButton prevButton;
   ...
   ResourceBundle shouldbuyResources;
   ...
   ShouldBuy()
     {  
      try
        {
         shouldbuyResources = ResourceBundle.getBundle("resources.shouldbuyResources",Locale.getDefault());
        }
      ...
      JFrame jfrm = new JFrame(shouldbuyResources.getString("ShouldBuy"));  
      ...
      prevButton = new JButton(shouldbuyResources.getString("Prev"));
      prevButton.setActionCommand("Prev");
      buttonPanel.add(prevButton);
      prevButton.addActionListener(this);
      
      nextButton = new JButton(shouldbuyResources.getString("Next"));
   ...
   private void nextUIState() throws Exception
     {
      ...
      if (fv.getFactSlot("state").toString().equals("final"))
        { 
         ...
         nextButton.setText(shouldbuyResources.getString("Restart")); 
         prevButton.setVisible(true);
        }
      else if (fv.getFactSlot("state").toString().equals("initial"))
        {
         nextButton.setActionCommand("Next");
         nextButton.setText(shouldbuyResources.getString("Next"));
      ...
      for (int i = 0; i < pv.size(); i++) 
        {
         ...
         if (bv.toString().equals(selected))
            { rButton = new JRadioButton(shouldbuyResources.getString(bv.toString()),true); 
             }
         else
            { rButton = new JRadioButton(shouldbuyResources.getString(bv.toString()),false);
            }
      ...
      String theText = shouldbuyResources.getString(fv.getFactSlot("display").symbolValue());
